...
#define INTRAFONT_WIDTH_FIX 0x00000800                    /*
                                                            set your custom fixed witdh to 24 pixels: INTRAFONT_WIDTH_FIX | 24
...
#define INTRAFONT_CACHE_ASCII 0x00008000                  /*
                                                            try to cache all ASCII chars during fontload (uses less memory and is faster to draw text, but slower to load font) 
...
#define INTRAFONT_CACHE_ALL 0x0000C000                    /*
                                                            try to cache all chars during fontload (uses less memory and is faster to draw text, but slower to load font)
